...
use Rodas\Diactoros\UploadedFile;
use Override;
...
final class ServerRequestFactoryTest extends TestCase
{
    ...
    public function testMarshalsExpectedHeadersFromServerArray(): void
    {
        ...
        $this->assertSame($expected, ServerRequestFactory::marshalHeadersFromSapi($server));
    }
    ...
    public function testMarshalsVariablesPrefixedByApacheFromServerArray(): void
    {
        ...
        $this->assertEquals($expected, ServerRequestFactory::marshalHeadersFromSapi($server));
    }
    ...
    {
        $server = ServerRequestFactory::normalizeServer([], static fn(): array => ['Authorization' => 'foobar']);
    ...
    public function testNormalizeServerReturnsArrayUnalteredIfApacheHeadersDoNotContainAuthorization(): void
    {
        ...
        $server = ServerRequestFactory::normalizeServer($expected, static fn(): array => []);
    ...
    public function testMarshalProtocolVersionRisesExceptionIfVersionIsNotRecognized(): void
    {
        ...
        ServerRequestFactory::marshalProtocolVersionFromSapi(['SERVER_PROTOCOL' => 'dadsa/1.0']);
    }

    public function testMarshalProtocolReturnsDefaultValueIfHeaderIsNotPresent(): void
    {
        $version = ServerRequestFactory::marshalProtocolVersionFromSapi([]);
    ...
    {
        $version = ServerRequestFactory::marshalProtocolVersionFromSapi(['SERVER_PROTOCOL' => $protocol]);
